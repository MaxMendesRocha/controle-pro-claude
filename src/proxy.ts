...
const GESTOR_PATHS = ['/dashboard', '/colaboradores', '/registros', '/holerites', '/ferias', '/regras', '/perfil'];
const COLABORADOR_PATHS = ['/meu-ponto', '/meus-registros', '/meu-holerite', '/minhas-ferias', '/meu-perfil'];
...
export const config = {
  matcher: ['/dashboard/:path*', '/colaboradores/:path*', '/registros/:path*', '/holerites/:path*', '/ferias/:path*', '/regras/:path*', '/perfil/:path*', '/meu-ponto/:path*', '/meus-registros/:path*', '/meu-holerite/:path*', '/minhas-ferias/:path*', '/meu-perfil/:path*'],
};